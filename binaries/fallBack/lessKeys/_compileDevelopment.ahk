...
sourcePathHookHandler := A_WorkingDir . "\..\hookHandler\_startHookHandler_development.ahk"
sourcePathHookReader := A_WorkingDir . "\..\hookReader\_startHookReader_development.ahk"
sourcePathLessKeys := A_WorkingDir . "\..\lessKeys\_LessKeys_development.ahk"
outputPathHookHandler := A_WorkingDir . "\..\environmentDependent\_development\binaries\startHookHandler.exe"
outputPathHookReader := A_WorkingDir . "\..\environmentDependent\_development\binaries\startHookReader.exe"
outputPathLessKeys := A_WorkingDir . "\..\environmentDependent\_development\binaries\LessKeys.exe"
