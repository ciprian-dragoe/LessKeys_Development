global ACTIVE_COMPUTER_X230 := "lenovo-x230"
...
#include %A_ScriptDir%\..\environmentDependent\_development\shortcuts\resolver\doublePress.ahk
#include %A_ScriptDir%\..\environmentDependent\_development\shortcuts\resolver\lidCloseSleep.ahk
...
resolverAction[23] := func("processEnter")
resolverAction[24] := func("processCtrlEnter")
resolverAction[25] := func("processCtrlShiftE")
resolverAction[26] := func("processCtrlShiftR")
resolverAction[51] := func("processShiftF1")
resolverAction[52] := func("processShiftF2")
resolverAction[53] := func("processFunctionKey")
resolverAction[54] := func("processNavigation")
resolverAction[55] := func("processCtrlQ")
resolverAction[56] := func("processF2")
resolverAction[71] := func("processModifierWithNumber")
resolverAction[72] := func("processAltShiftDirection")
