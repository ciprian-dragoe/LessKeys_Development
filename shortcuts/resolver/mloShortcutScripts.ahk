...
;   if (A_WDay = 1) ; sunday 
    ...
    {
        extraInstructions := ["{home}", MLO_KEYBOARD_SHORTCUT_COLLAPSE_ALL_TASKS, "{right}", "{down 2}"]
    } 
    ...
    {
        extraInstructions := [MLO_KEYBOARD_SHORTCUT_COLLAPSE_ALL_TASKS, "^a", MLO_KEYBOARD_SHORTCUT_CURRENT_TASK_SHOW_LEVEL_1, "{home}{down}"]
    }
    else if (number = 2 && modifiers = "^+")
    {
