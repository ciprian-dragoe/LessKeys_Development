...
global POMODORO_QUESTIONS := ["__PASI INTENTIONEZ SA FAC: ", "__FAC PAUZA DE LA: "]
...
getFocusArea(input)
{
    ...
    allowedFocusAreas := ["11", "110", "12", "120", "13" "130", "22", "220", "18", "23", "230", "24", "240", "28", "33", "330", "34", "340", "35", "350", "38" ,"44", "440", "45", "450", "46", "460", "48", "55", "550", "56", "560", "58", "61" ,"62" ,"63" ,"64", "65", "66", "68", "71", "72", "73", "74", "75", "76", "77", "78"]
    for key, allowedArea in allowedFocusAreas
    {
        if (InStr(focusArea, allowedArea) = 1) {
            return allowedArea
        }
    }
    return 0
